package com.smart.website.domain.customer;

import com.alibaba.cola.domain.Entity;
import com.alibaba.cola.exception.BizException;
import lombok.Data;

import com.smart.website.dto.domainmodel.*;

//Domain Entity can choose to extends the domain model which is used for DTO
@Data
@Entity
public class Customer extends com.smart.website.dto.domainmodel.Customer {
