...
@Entity
@Table(name = "sys_web_log", schema = "account", catalog = "")
public class SysWebLogEntity {
    ...
    @Basic
    @Column(name = "operation_desc", nullable = true, length = 955)
    ...
    public boolean equals(Object o) {
        ...
        if (timeMin != null ? !timeMin.equals(that.timeMin) : that.timeMin != null) return false;
