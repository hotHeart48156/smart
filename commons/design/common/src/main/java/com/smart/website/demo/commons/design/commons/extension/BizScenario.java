package com.smart.website.demo.commons.design.commons.extension;
...
public class BizScenario {
    ...
    /**
     * bizId is used to identify a business, such as "tm${parentArtifactId}", it's nullable if there is only one biz
     */
    ...
    /**
     * For above case, the BizScenario will be "tm${parentArtifactId}.placeOrder.88vip",
     * with this code, we can provide extension processing other than "tm${parentArtifactId}.placeOrder.normal" scenario.
     *
     * @return
     */
