package com.smart.website.demo.commons.design.core.context;

import com.smart.website.account.exception.BizException;
...
public class ColaContext {
     ...
     * @return
     */
    public static <T> void doWithinContext(ContextDO context, Supplier<T> supplier) {
     ...
     *
     * @param ${parentArtifactId}Context
     */
    public static void setContext(Set<ColaContextSupprot> set) {
        set.forEach(ColaContext::setContext);
    }
