package com.smart.website.demo.commons.design.test.container;


import com.smart.website.demo.commons.design.core.logger.Logger;
import com.smart.website.demo.commons.design.core.logger.LoggerFactory;
import com.smart.website.demo.commons.design.test.container.command.TestClassRunCmd;
import com.smart.website.demo.commons.design.test.container.command.TestMethodRunCmd;
import com.smart.website.demo.commons.design.test.mock.listener.ColaNotifier;
import com.smart.website.demo.commons.design.test.mock.model.ColaTestDescription;
import com.smart.website.demo.commons.design.test.mock.utils.reflection.BeanMetaUtils;
...
public class TestExecutor {
    ...
    private void runClassTest(TestClassRunCmd cmd, Class<?> testClz, Object testInstance)throws Exception{
        ...
        Method[] Methods = testClz.getMethods();
    ...
    private void trySetFieldValue(Field field, Object testInstance, String beanName){
        try {
            ...
            if(StringUtils.isNotBlank(e.getMessage()) && e.getMessage().indexOf("${symbol_escape}${symbol_escape}${symbol_dollar}Proxy") > 0){
