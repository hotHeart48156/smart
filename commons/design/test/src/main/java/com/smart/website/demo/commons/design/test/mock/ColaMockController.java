...
import com.smart.website.demo.commons.design.test.mock.proxy.MockDataProxy;
import com.smart.website.demo.commons.design.test.mock.scan.AutoMockFactoryBean;
...
public class ColaMockController implements BeanDefinitionRegistryPostProcessor, BeanPostProcessor, InitializingBean
    ...
    private final static String COLAMOCK_PROXY_FLAG = "${symbol_escape}${symbol_escape}${symbol_dollar}${symbol_escape}${symbol_escape}${symbol_dollar}EnhancerByColaMockWithCGLIB";
