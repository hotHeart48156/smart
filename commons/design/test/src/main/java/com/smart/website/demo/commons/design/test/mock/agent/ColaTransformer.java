package com.smart.website.demo.commons.design.test.mock.agent;

#set( $symbol_pound = '#' )
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.mock.agent;
...
import ${package}.mock.agent.transformlet.AbstractTransformlet;
import ${package}.mock.agent.transformlet.DefaultConstructTransformlet;
import ${package}.mock.agent.transformlet.OnlineRecordTransformlet;
import ${package}.mock.agent.transformlet.TransformletUtils;
