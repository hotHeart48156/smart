package com.smart.website.demo.commons.design.test.mock.autotest;

#set( $symbol_pound = '#' )
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.mock.autotest;
...
import static ${package}.mock.utils.Constants.DOT;
import static ${package}.mock.utils.Constants.NOTE_SYMBOL;
...
public class TestClass {
    ...
    /**
     * ${symbol_dollar}{testClass}${symbol_dollar}${symbol_dollar}{testMethod}Test
     * 实际测试类名
     * @return
     */
    ...
    public List<String> buildVarDefinition(){
        ...
        for(int i=0; i< paramterClassLst.length; i++){
            ...
            if(i < params.length && isAutoGenerateData(params[i])){
                vars.add(paramterClassLst[i].getSimpleName() + " " + paramterName + " = ColaMockito.getDataMap(${symbol_escape}"" + paramterName + "${symbol_escape}")");
    ...
    private Object convert2Param(Class type, Object paramValue){
        if(type == String.class){
            return paramValue.toString().endsWith("${symbol_escape}"") ? paramValue.toString() : "${symbol_escape}"" + paramValue + "${symbol_escape}"";
