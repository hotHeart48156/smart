package com.smart.website.demo.commons.design.test.mock.model;
...
import ${package}.mock.utils.CommonUtils;
...
public class StackNode {
    ...
    protected String pretty2DependencyTree(String prefix){
        ...
        String selfPrefix = prefix + (isLast?"${symbol_escape}${symbol_escape}- ":"+- ");
        String lineStr = line > 0 ? "("+CommonUtils.getSimpleClassName(this.className)+".java:" + line + ")" : ":mock service";
        sb.append(selfPrefix).append(className + ".").append(method).append(lineStr).append("${symbol_escape}n");
