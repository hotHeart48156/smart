...
import ${package}.mock.utils.StackSearcher;
...
public class StackTree {
    ...
    public String toString(){
        StringBuilder sb = new StringBuilder("${symbol_escape}n============cola trace============${symbol_escape}n");
        for(StackNode node : nodeList){
            sb.append(node.toString()).append("${symbol_escape}n");
        }
