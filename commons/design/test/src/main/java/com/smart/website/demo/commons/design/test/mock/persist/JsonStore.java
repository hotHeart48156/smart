...
import ${package}.mock.utils.JsonUtils;
...
import ${package}.mock.model.HeaderVersion;
import ${package}.mock.model.InputListOfSameNameMethod;
import ${package}.mock.model.InputParamsFile;
import ${package}.mock.model.InputParamsOfOneMethod;
import ${package}.mock.model.MockData;
import ${package}.mock.model.MockDataFile;
import ${package}.mock.utils.Constants;
import ${package}.mock.utils.FileUtils;
...
public class JsonStore implements DataStore {
    ...
    public static void main(String[] args){
        ...
        String jsonArr = "[${symbol_escape}n"
            + "${symbol_escape}t[${symbol_escape}n"
            + "        ${symbol_escape}"i m a string${symbol_escape}",${symbol_escape}n"
            + "            {${symbol_escape}n"
            + "                ${symbol_escape}"@type${symbol_escape}":${symbol_escape}"${package}.mock.persist.JsonStore${symbol_dollar}TestA${symbol_escape}",${symbol_escape}n"
            + "            ${symbol_escape}"field1${symbol_escape}":${symbol_escape}"111${symbol_escape}",${symbol_escape}n"
            + "            ${symbol_escape}"field2${symbol_escape}":${symbol_escape}"222${symbol_escape}"${symbol_escape}n"
            + "${symbol_escape}t${symbol_escape}t},${symbol_escape}n"
            + "        null${symbol_escape}n"
            + "${symbol_escape}t],${symbol_escape}n"
            + "${symbol_escape}t[${symbol_escape}n"
            + "        ${symbol_escape}"i m a string${symbol_escape}",${symbol_escape}n"
            + "            {${symbol_escape}n"
    ...
    private void writeLine(RandomAccessFile raf, String line) throws IOException {
        ...
        raf.write("${symbol_escape}r${symbol_escape}n".getBytes("utf-8"));
    }
