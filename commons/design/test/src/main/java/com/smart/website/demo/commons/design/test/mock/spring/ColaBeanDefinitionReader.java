...
public class ColaBeanDefinitionReader extends XmlBeanDefinitionReader{
     ...
     * C${parentArtifactId}ed by {@code loadBeanDefinitions}.
     ...
     * @see ${symbol_pound}loadBeanDefinitions
     * @see ${symbol_pound}setDocumentReaderClass
     * @see BeanDefinitionDocumentReader${symbol_pound}registerBeanDefinitions
     */
    @Override
