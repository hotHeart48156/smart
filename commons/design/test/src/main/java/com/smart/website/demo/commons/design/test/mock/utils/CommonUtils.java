...
import static ${package}.mock.utils.Constants.OS_WINDOWS;
...
public class CommonUtils {
    ...
    public static String getSimpleClassName(String className){
        String[] sp = className.split("${symbol_escape}${symbol_escape}.");
        String simpleClassName = sp[sp.length - 1];
        String[] sp2 = simpleClassName.split("${symbol_escape}${symbol_escape}${symbol_dollar}${symbol_escape}${symbol_escape}${symbol_dollar}");
        return sp2[0];
    }
    ...
    public static void main(String[] args) {
        ...
        s.add("${package}.mock.utils.CommonUtils");
        s.add("${package}.mock.utils.AA");
