...
public class FileUtils {
    ...
    public static final String PACKAGE_SPLITER_REGEP = "${symbol_escape}${symbol_escape}.";
    ...
    public static String convertPackage2Path(String packagePath){
        packagePath = packagePath.replaceAll("${symbol_escape}${symbol_escape}.", "/");
        return packagePath + "/";
    }

    public static String appendSlashToURILast(String srcResource){
        srcResource.replaceAll("${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}", "/");
