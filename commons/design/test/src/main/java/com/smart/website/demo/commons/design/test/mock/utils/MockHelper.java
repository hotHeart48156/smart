...
import org.springframework.cglib.proxy.C${parentArtifactId}back;
...
public class MockHelper {
    ...
    public static Class createMockClass(Class clazz){
        ...
        enhancer.setC${parentArtifactId}backTypes(new Class[]{MethodInterceptor.class});
    ...
    public static Object createMockFor(Class clazz, MethodInterceptor interceptor){
        ...
        proxy.setC${parentArtifactId}backs(new C${parentArtifactId}back[] {interceptor});
        return proxy;
    }
