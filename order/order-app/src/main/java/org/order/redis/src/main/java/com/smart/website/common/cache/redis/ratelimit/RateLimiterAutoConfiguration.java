...
package org.order.redis.src.main.java.com.smart.website.common.cache.redis.ratelimit;


import org.order.redis.src.main.java.com.smart.website.common.cache.redis.configuration.RedisConfigurationI;
 ...
 */
@Configuration
@ConditionalOnProperty(value = "redis.rate-limiter.enable")
public class RateLimiterAutoConfiguration implements RedisConfigurationI {
