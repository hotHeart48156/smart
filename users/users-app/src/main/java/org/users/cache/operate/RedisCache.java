...
package org.users.cache.operate;
...
import org.users.cache.src.main.java.com.smart.website.common.cache.cache.CacheKey;
import org.users.cache.src.main.java.com.smart.website.common.cache.configuration.CacheOperate;
import org.users.core.src.main.java.com.smart.website.common.core.utils.CollectionUtil;
...
public class RedisCache implements SmartInitializingSingleton, CacheOperate {
    ...
    public void set(CacheKey cacheKey, Object value) {
        String key = cacheKey.getKey().toString();
    ...
    public Boolean del(CacheKey key) {
        return redisTemplate.delete(key.getKey().toString());
    }
